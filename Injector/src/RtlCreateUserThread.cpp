...
bool RtlCreateUsreThread_type5(HANDLE hProcess, LPCSTR DllPath) {
    ...
    LPVOID LoadLibraryAddr = (void *) GetProcAddress(GetModuleHandle("kernel32.dll"), "LoadLibraryA");
...
//	Sleep(1000);
    ...
    pRtlCreatUserThread pfunc_RtlCreateUserThread = (pRtlCreatUserThread) GetProcAddress(modNtDll,
                                                                                         "RtlCreateUserThread");
