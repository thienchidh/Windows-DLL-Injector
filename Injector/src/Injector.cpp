...
LPCSTR DllPath = "D:/other/pikachu/Windows-DLL-Injector/Build/PayloadDLLBuild/bin/Release/x64/PayloadDLL.dll";

#else

LPCSTR DllPath = "D:/other/pikachu/Windows-DLL-Injector/Build/PayloadDLLBuild/bin/Release/Win32/PayloadDLL.dll";
